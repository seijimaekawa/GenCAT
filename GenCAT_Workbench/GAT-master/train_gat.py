...
# checkpt_file = '/content/drive/My Drive/Colab Notebooks/GenCAT/GAT-master/pre_trained/cora/mod_cora.ckpt'
...
flags.DEFINE_float('l2_coef', 5e-4, 'Weight for L2 loss on embedding matrix.')
...
with open(FLAGS.root_path+"experimental_results/GAT_"+FLAGS.dataset+"_iter"+str(FLAGS.iter_count), 'w') as f:
